...
export const Header = () => {
  return (
    <header className="flex flex-col items-center header--group">
      ...
      <div className="custom-purple flag w-full md:flex md:items-center md:justify-center custom-grad text-center avenir-black text-2xl md:text-3xl pt-3 pb-3 bg-cover">
